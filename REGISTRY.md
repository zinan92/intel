...
- The Weekly Sunday 08:30 plus Monday catch-up launchd template and runner are now available on `main`; the service remains disabled until final issue #16 enablement.
...
- Complete park-ai-intel#59 in parallel, then use #16 for one controlled live publication, idempotency proof, launchd enablement, and final registry state.
